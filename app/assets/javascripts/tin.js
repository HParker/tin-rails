...
var _user$project$AutoComplete$getAt = F2(
	function (xs, idx) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, idx, xs));
	});
var _user$project$AutoComplete$backupCompletions = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$AutoComplete$completionMatch = F2(
	function (command, completion) {
		var keyword = function () {
			var _p0 = _elm_lang$core$List$head(
				A2(_elm_lang$core$String$split, ' ', command));
			if (_p0.ctor === 'Just') {
				return _elm_lang$core$String$toLower(_p0._0);
			} else {
				return '';
			}
		}();
		return A2(_elm_lang$core$String$startsWith, keyword, completion.command);
	});
var _user$project$AutoComplete$moveSelection = F2(
	function (key, model) {
		var potentialSelection = model.selection - key.y;
		var visibleCompletions = A2(
			_elm_lang$core$List$filter,
			_user$project$AutoComplete$completionMatch(model.command),
			model.completions);
		var newSelection = ((_elm_lang$core$Native_Utils.cmp(potentialSelection, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(
			potentialSelection,
			_elm_lang$core$List$length(visibleCompletions)) < 0)) ? potentialSelection : model.selection;
		var fx = function () {
			var _p1 = A2(_user$project$AutoComplete$getAt, visibleCompletions, model.selection);
			if (_p1.ctor === 'Just') {
...
var _user$project$AutoComplete$update = F2(
	function (action, model) {
		var _p2 = action;
		switch (_p2.ctor) {
			case 'StoreCompletions':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{completions: _p2._0});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ArrowPress':
				return A2(_user$project$AutoComplete$moveSelection, _p2._0, model);
			case 'Complete':
...
var _user$project$AutoComplete$Completion = F2(
	function (a, b) {
		return {command: a, info: b};
	});
var _user$project$AutoComplete$decodeCompletion = _elm_lang$core$Json_Decode$list(
	A3(
		_elm_lang$core$Json_Decode$object2,
		F2(
			function (action, info) {
				return A2(_user$project$AutoComplete$Completion, action, info);
			}),
...
var _user$project$AutoComplete$Model = F4(
	function (a, b, c, d) {
		return {selection: a, visible: b, completions: c, command: d};
	});
var _user$project$AutoComplete$init = A4(
	_user$project$AutoComplete$Model,
	0,
	false,
	_elm_lang$core$Native_List.fromArray(
		[]),
	'');
var _user$project$AutoComplete$NoOp = {ctor: 'NoOp'};
var _user$project$AutoComplete$ShowCompletion = function (a) {
	return {ctor: 'ShowCompletion', _0: a};
};
var _user$project$AutoComplete$Complete = function (a) {
	return {ctor: 'Complete', _0: a};
};
var _user$project$AutoComplete$show = F3(
	function (selected, current, completion) {
		var completionClass = _elm_lang$core$Native_Utils.eq(selected, current) ? 'selected-completion completion' : 'completion';
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$AutoComplete$Complete(completion.command)),
					_elm_lang$html$Html_Attributes$class(completionClass)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('command')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(completion.command)
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(completion.info)
						]))
				]));
	});
var _user$project$AutoComplete$view = function (model) {
	var visible = A2(
		_elm_lang$core$List$filter,
		_user$project$AutoComplete$completionMatch(model.command),
		model.completions);
	return model.visible ? A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('completions')
			]),
		A2(
			_elm_lang$core$List$indexedMap,
			_user$project$AutoComplete$show(model.selection),
			visible)) : A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$AutoComplete$ArrowPress = function (a) {
	return {ctor: 'ArrowPress', _0: a};
};
var _user$project$AutoComplete$FetchFailed = function (a) {
	return {ctor: 'FetchFailed', _0: a};
};
var _user$project$AutoComplete$StoreCompletions = function (a) {
	return {ctor: 'StoreCompletions', _0: a};
};
var _user$project$AutoComplete$fetch = function ($package) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$AutoComplete$FetchFailed,
		_user$project$AutoComplete$StoreCompletions,
		A2(
			_evancz$elm_http$Http$get,
			_user$project$AutoComplete$decodeCompletion,
			A2(_elm_lang$core$Basics_ops['++'], '/completion/?pack=', $package)));
};
...
var _user$project$Card$update = F2(
	function (action, model) {
		...
		switch (_p0.ctor) {
			case 'Collapse':
				var toggle = model.collapsed ? false : true;
				return _elm_lang$core$Native_Utils.eq(model.id, _p0._0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{collapsed: toggle}),
...
var _user$project$Card$collapse = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{collapsed: true});
};
var _user$project$Card$Model = F4(
	function (a, b, c, d) {
		return {title: a, body: b, id: c, collapsed: d};
	});
var _user$project$Card$build = F3(
	function (title, body, id) {
		return A4(_user$project$Card$Model, title, body, id, false);
	});
var _user$project$Card$decode = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Card$build,
...
var _user$project$Card$view = function (card) {
	var _p1 = card.collapsed ? {ctor: '_Tuple2', _0: '', _1: 'card-icon icon octicon octicon-chevron-up'} : {ctor: '_Tuple2', _0: card.body, _1: 'card-icon icon octicon octicon-chevron-down'};
	var cardBody = _p1._0;
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class(collapseIcon),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Card$Collapse(card.id))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _user$project$Card$NoOp = {ctor: 'NoOp'};

var _user$project$Cards$addCards = F2(
	function (newCards, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				cards: A2(_elm_lang$core$Basics_ops['++'], model.cards, newCards)
			});
	});
var _user$project$Cards$add = F2(
	function (card, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				cards: A2(_elm_lang$core$List_ops['::'], card, model.cards),
				nextID: model.nextID + 1
			});
	});
var _user$project$Cards$Model = F2(
	function (a, b) {
		return {cards: a, nextID: b};
	});
var _user$project$Cards$init = A2(
	_user$project$Cards$Model,
	_elm_lang$core$Native_List.fromArray(
		[]),
	0);
...
var _user$project$Cards$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _user$project$Cards$viewCard, model.cards));
};
var _user$project$Cards$AddFailed = function (a) {
	return {ctor: 'AddFailed', _0: a};
};
var _user$project$Cards$Add = function (a) {
	return {ctor: 'Add', _0: a};
};
var _user$project$Cards$getCard = function (command) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Cards$AddFailed,
		_user$project$Cards$Add,
		A2(
			_evancz$elm_http$Http$get,
			_user$project$Card$decode,
			A2(_elm_lang$core$Basics_ops['++'], 'api/?q=', command)));
};
		...
		switch (_p0.ctor) {
			case 'Get':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Cards$getCard(_p0._0)
				};
			case 'Add':
				var newCards = A2(
					_elm_lang$core$List_ops['::'],
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{cards: newCards, nextID: model.nextID + 1}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Card':
				var _p4 = _p0._0;
...
var _user$project$Cards$Get = function (a) {
...
var _user$project$Input$storeCommand = F2(
	function (command, model) {
		...
		var newCompletions = _elm_lang$core$Native_Utils.update(
			completions,
			{command: command});
		return _elm_lang$core$Native_Utils.update(
			model,
			{command: command, completions: newCompletions});
	});
var _user$project$Input$Model = F2(
	function (a, b) {
		return {command: a, completions: b};
	});
var _user$project$Input$StoreVal = function (a) {
	return {ctor: 'StoreVal', _0: a};
};
var _user$project$Input$AutoComplete = function (a) {
	return {ctor: 'AutoComplete', _0: a};
};
var _user$project$Input$init = {
	ctor: '_Tuple2',
	_0: A2(_user$project$Input$Model, '', _user$project$AutoComplete$init),
	_1: A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Input$AutoComplete,
		_user$project$AutoComplete$fetch('default'))
};
var _user$project$Input$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'StoreVal':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Input$storeCommand, _p0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Completions':
				return {
			...
			case 'AutoComplete':
				...
				if (_p1.ctor === 'Complete') {
					...
					var _p2 = A2(_user$project$AutoComplete$update, _p3, model.completions);
					...
					return {
						...
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Input$AutoComplete, fx)
					};
				}
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Input$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('main-interface')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$html$Html_App$map,
				_user$project$Input$AutoComplete,
				_user$project$AutoComplete$view(model.completions))
			]));
};
var _user$project$Input$Completions = function (a) {
	return {ctor: 'Completions', _0: a};
};
...
var _user$project$Main$makeRequest = function (model) {
	var _p0 = A2(
		_user$project$Cards$update,
		_user$project$Cards$Get(model.input.command),
		model.cards);
	var cards = _p0._0;
	var fx = _p0._1;
	var newHistories = A2(
...
var _user$project$Main$update = F2(
	function (action, model) {
		...
		switch (_p2.ctor) {
			case 'HandleKeypress':
				return _elm_lang$core$Native_Utils.eq(_p2._0, 13) ? _user$project$Main$makeRequest(model) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Input':
				var _p3 = A2(_user$project$Input$update, _p2._0, model.input);
				var input = _p3._0;
				var fx = _p3._1;
				return {
					ctor: '_Tuple2',
				...
				if (_p4.ctor === 'Move') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								pins: A2(_user$project$Cards$addCards, _p4._0, model.pins)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p5 = A2(_user$project$Cards$update, _p6, model.cards);
					var cards = _p5._0;
					var fx = _p5._1;
					return {
						ctor: '_Tuple2',
				...
				if (_p7.ctor === 'Move') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								cards: A2(_user$project$Cards$addCards, _p7._0, model.cards)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p8 = A2(_user$project$Cards$update, _p9, model.pins);
					var cards = _p8._0;
					var fx = _p8._1;
					return {
						ctor: '_Tuple2',
			...
			default:
				var _p10 = A2(_user$project$Cards$update, _p2._0, model.pins);
				var cards = _p10._0;
				var fx = _p10._1;
				return {
					ctor: '_Tuple2',
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Input$view(model.input)),
						A2(
						_elm_lang$html$Html_App$map,
						_user$project$Main$Cards,
						_user$project$Cards$view(model.cards))
					]))
			]));
};
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			subscriptions: function (_p11) {
				return _elm_lang$keyboard$Keyboard$presses(_user$project$Main$HandleKeypress);
			}
		})
};
